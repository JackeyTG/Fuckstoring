    ...
    if usr_cmd == "/start":
        ...
        await cmd.reply_text(
            ...
            reply_markup=InlineKeyboardMarkup(
                [
                    [
                        InlineKeyboardButton("Support Group", url="https://t.me/jackeybots_support"),
                        InlineKeyboardButton("Bots Channel", url="https://t.me/jackeybots")
                    ],
                    [
...
async def main(bot: Client, message: Message):
    ...
    if message.chat.type == enums.ChatType.PRIVATE:
        ...
        try:
            ...
            share_link = f"https://t.me/{Config.BOT_USERNAME}?start=JackeyBots_{str_to_b64(file_er_id)}"
                ...
                [
                    [
                        InlineKeyboardButton("Source Codes of Bot",
                                             url="https://t.me/+og0nG15YGFU1OTc1")
                    ],
                    [
        ...
        if Config.UPDATES_CHANNEL:
            ...
            try:
                ...
                if user.status == "kicked":
                    await cmd.message.edit(
                        text="Sorry Sir, You are Banned to use me. Contact my [Support Group](https://t.me/jackeybots_support).",
                        disable_web_page_preview=True
                    )
                    return
                ...
                await cmd.message.edit(
                    text="Something went Wrong. Contact my [Support Group](https://t.me/Jackeybots_support).",
                    disable_web_page_preview=True
                )
                return
        await cmd.message.edit(
